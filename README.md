...
#### Request params
|name|type|location|possible values|default|description|
| ------------- |:-------------:|-------------:|-------------:|-------------:|-------------:|
|response_mode|string|query|`json`, `text_plain_only_heart_rate`|`json`|Allow control format of response|
...
---------------
This method allows reading the heart rate of the user in real-time. Websocket connection can be interrupted at any point in time, make sure to have retry logic with backoff. To pass OAuth access token query parameter  `access_token` is used.    
#### Request
| name        | value|           
| ------------- |:-------------:|
...
|name|type|location|possible values|default|description|
| ------------- |:-------------:|-------------:|-------------:|-------------:|-------------:|
|access_token|string|query|-|-|Used to path auth token in WebSocket request|
